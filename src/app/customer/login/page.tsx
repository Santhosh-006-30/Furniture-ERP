...
export default function CustomerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store customer session credentials in localStorage
      localStorage.setItem('customer_portal_user', JSON.stringify(response.user));
      localStorage.setItem('customer_portal_token', response.token);
