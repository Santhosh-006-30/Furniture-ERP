...
export default function LayoutWrapper({ children }: LayoutWrapperProps) {
  ...
  const menuItems = [
    { name: 'Dashboard', path: '/dashboard', icon: LayoutDashboard, roles: ['ADMIN', 'SALES', 'PURCHASE', 'MANUFACTURING', 'INVENTORY', 'OWNER', 'CUSTOMER'] },
    { name: 'Products', path: '/products', icon: Package, roles: ['ADMIN', 'SALES', 'MANUFACTURING', 'INVENTORY', 'OWNER', 'CUSTOMER'] },
    { name: 'Customers', path: '/customers', icon: UserRound, roles: ['ADMIN', 'SALES', 'OWNER', 'CUSTOMER'] },
    { name: 'Sales', path: '/sales', icon: ShoppingCart, roles: ['ADMIN', 'SALES', 'OWNER', 'CUSTOMER'] },
